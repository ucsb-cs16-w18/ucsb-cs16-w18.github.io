...
<ul>
  ...
  <li><strong>(2) Homework/Quizzes</strong>—In every lab section, you'll be given a homework assignment that is due the following week. You do not have to turn in the paper copy of your homework, rather you are highly encouraged to complete the paper copy and then complete a related quiz on gauchospace to earn points for the homework.
   <br />
